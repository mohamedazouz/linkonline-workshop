...
class Cdb
{
	...
	public function generate_select_sql($table, $where_sql = false, $where_fields_values = false, $custom_select_sql = false, $order = false, $limit = false)
	{
		$where_part = '';
	...
	public function select_record($table, $where_sql = false, $where_fields_values = false, $custom_select_sql = false, $order = false, $limit = false)
	{
		$data = $this->select($table, $where_sql, $where_fields_values, $custom_select_sql, $order, $limit);
		if ($data) $data = $data[0];
                else return false;
	...
	public function select_value($table, $where_sql = false, $where_fields_values = false, $custom_select_sql = false, $order = false, $limit = false)
	{
		$data = $this->select_record($table, $where_sql, $where_fields_values, $custom_select_sql, $order, $limit);
                if ($data) $data = $data[$custom_select_sql];
		return $data;
	}
